...
export default function LearnWith() {
    ...
    return (
        <section className="bg-gradient-to-br from-[#FFF8F0] via-[#FFFAF5] to-white py-2 flex items-center justify-center flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center w-full px-6 md:px-12 py-10 md:py-0">
                    ...
                    <div className="flex flex-col space-y-3 sm:space-y-4">
                        {buttons.map((button, index) => (
                            <div key={index} className="relative mb-2">
                                <button className="specifibtn bg-blue-500 text-white px-6 py-1 w-[180px] sm:w-[200px] hover:bg-blue-600 text-sm sm:text-base md:text-lg font-semibold rounded-md transition">
                                    {button.label}
                                </button>
                            </div>
                        ))}
                ...
                <div className="order-2 md:order-1 flex justify-center md:justify-end">
                    <div className="w-full max-w-sm md:max-w-md mx-auto">
                        <div className="relative w-full h-[300px] sm:h-[300px] md:h-[350px] lg:h-[450px] flex items-center justify-center">
                            <Image
                                src="/image33.svg"
                                alt="Tegore"
                                fill
