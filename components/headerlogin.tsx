                    ...
                    {open && (
                        <div className="absolute  right-0 mt-3 bg-white border border-black border-3 shadow-lg w-40 z-10">
                            ...
                            <ul className="text-sm text-gray-700">
                                ...
                                <li onClick={onOpenModal} className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
                                    Contact Support
                                </li>
                                <li onClick={onopenFeedack} className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
                                    Manage Plan
                                </li>
                                <li onClick={onopenFeedackSubmit} className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
                                    Submit
                                </li>
                            </ul>
                        </div>
